...
class Microphone:
    ...
    def create_decoder():
        ...
        print(path)
        path3=os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(path)))))
        print(path3)
        pocketsphinx_data = os.getenv('POCKETSPHINX_DATA', os.path.join(path3, 'share/spark_voice/spark_voice/lib/pocketsphinx-data'))
        print(pocketsphinx_data)
