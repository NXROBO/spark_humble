...
def generate_launch_description():
    ...
    declare_serial_port = DeclareLaunchArgument(
        ...
        description='serial port name:/dev/ttyUSB0 or /dev/sparkBase')
    ...
    spark_yolov8_object_detector_node = launch_ros.actions.Node(
    ...
    spark_object_detector_rviz_node = launch_ros.actions.Node(
        package='rviz2',
        executable='rviz2',
        name='rviz2',
    ...
    ld.add_action(spark_yolov8_object_detector_node)
    ld.add_action(spark_object_detector_rviz_node)
