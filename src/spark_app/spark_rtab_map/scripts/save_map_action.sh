...
gnome-terminal --title="save_map_action"  -- bash -c "ros2 run nav2_map_server map_saver_cli -f ${PROJECTPATH}/../../../spark_navigation2/share/spark_navigation2/map/map --ros-args -p save_map_timeout:=100000"
