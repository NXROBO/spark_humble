...
def generate_launch_description():
    ...
    spark_darknet_dir = get_package_share_directory('darknet_ros')
    ...
    deep_learn_group = GroupAction([
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource(os.path.join(spark_darknet_dir, 'launch',
                                                       'darknet_ros.launch.py')),
            launch_arguments={'image': image,}.items()),
    ])
    ...
    ld.add_action(deep_learn_group)
